"""
Knowledge-base tables: machines, materials, operations, pricing.

These feed the agents (via ``db.repositories.kb``) and the admin CRUD
surface (via ``db.repositories.admin``).
"""
